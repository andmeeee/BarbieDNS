	...
	<table class="main" align="center" cellspacing="0" cellpadding="0">
		...
		<td>
			<table class="content" cellpadding="20" bgcolor="white">
                ...
                <h2 align="center">Сервисный центр</h2>
               <p> Просто решаем сложные проблемы.<br>Ремонтируем цифровую и бытовую технику в 226 городах России.</p> 
               <div  style="display: flex; flex-direction: row; justify-content: space-evenly;">
                    <div class="block">
                        <img src="img\safe.png">
                        <p align="center">Возврат, обмен или ремонт</p>
                    </div>
                    <div class="block">
                        <img align="center" src="img\search.png">
                        <p align="center">Поиск сервисных центров</p>
                    </div>
                    </div>
                    <div style="display: flex; flex-direction: row; justify-content: space-evenly;">
                    <div class="block">
                        <img src="img\driver.png">
                        <p align="center">Драйверы и инструкции</p>
                    </div>
                    <div class="block">
                        <img src="img\guarantee.png">
                        <p align="center">Платный ремонт и реставрация</p>
                    </div>
               </div>
               <p>Уже 35 мировых брендов доверили нам право ремонтировать их устройства.<br>
                Компании: Apple, Epson, Brother, Canon, Xiaomi, Indesit и другие</p>
                <h3 align="center">Звоните нам!</h3>
                <h3 align="center" style="color: rgb(240, 100, 205)">8-800-770-7-888 </h3>
                <p align="center">c 10:00 до 21:00 <br>
                    DNS Сервис в г. Москва</p></td>
			</table>
